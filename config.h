 ...
 */
static char *font = "Hack:pixelsize=12:antialias=true:autohint=true:rgba=none:hintstyle=hintfull";
//static char *font = "Hack Nerd Font:pixelsize=12:antialias=true:autohint=true:rgba=none:hintstyle=hintfull";
...
//static float cwscale = 0.8; //hack nerd font
...
/* bg opacity */
float alpha = 0.99, alphaUnfocused = 0.96;
